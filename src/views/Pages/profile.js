  ...
  return (
    <>
      <div className='d-flex justify-content-center mb-4' style={{ alignItems: "center" }}>
        <svg className='mr-3 bg-primary p-2 rounded-circle' style={{ marginRight: '10px' }} width="70" height="70" viewBox="0 0 24 24"><path fill='#fff' d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z" /></svg>
        <div className='d-flex' style={{ flexDirection: "column" }}>
          <span className='fw-bold'>{user?.nama}</span>
          <span className='fw-bold'>{user?.no_wa}</span>
          <span className='fw-bold'>{user?.nama_event}</span>
        </div>
      </div>
